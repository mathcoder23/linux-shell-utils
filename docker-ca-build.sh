...
echo "subjectAltName = IP:172.17.0.1,IP:127.0.0.1,IP:172.31.21.206,IP:${IP}" > $dir/extfile.cnf
echo "通过ca签署证书"
openssl x509 -req -days 365 -sha256 -in $dir/server.csr -CA $dir/ca.pem -CAkey $dir/ca-key.pem \
  -CAcreateserial -out $dir/server-cert.pem -extfile $dir/extfile.cnf
...
openssl x509 -req -days 365 -sha256 -in $dir/client.csr -CA $dir/ca.pem -CAkey $dir/ca-key.pem \
  -CAcreateserial -out $dir/cert.pem -extfile $dir/extfile.cnf
